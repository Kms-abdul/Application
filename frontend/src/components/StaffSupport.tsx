                        ...
                        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                            ...
                            {isSubmitted ? (
                                <div className="p-10 flex flex-col items-center text-center min-h-96">
                                    ...
                                    <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold mb-4 ${isCopied
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-3 w-full max-w-md">
                                        <button
                                            ...
                                            className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-semibold transition-all border ${isCopied
                                ...
                                <form onSubmit={handleSubmit} noValidate className="p-6 space-y-5">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {categories.map((cat) => (
                                                <button
                                                    ...
                                                    className={`px-3 py-1.5 rounded-full text-xs font-semibold border transition-all duration-200 flex items-center gap-1.5 ${category === cat.label
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className={`w-full pl-10 pr-4 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-2 transition-all bg-gray-50 focus:bg-white ${errors.subject
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            className={`w-full px-4 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-2 transition-all resize-none bg-gray-50 focus:bg-white ${errors.message
                                                ? 'border-red-400 focus:ring-red-300'
                                                : 'border-gray-200 focus:ring-green-300 focus:border-green-400'
                                                }`}
                                        />
                            ...
                            <div className="space-y-2.5">
                                {[
                                    ...
                                    <div key={i} className="flex justify-between items-center">
                                        ...
                                        <span className={`text-xs font-semibold px-2.5 py-1 rounded-full ${item.active ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-600'
                                            }`}>
                                            {item.time}
                                        </span>
                                    </div>
