...
const UpdateRebateDate: React.FC = () => {
    ...
    const fetchInstallments = async () => {
        try {
            ...
            // Filter installments to current academic year if needed (backend usually does this)
            const filtered = response.data.filter((inst: Installment) => inst.academic_year === academicYear);
